...
def line_scan_setup(p,mod_template,obs_template,outf):
    ...
    mod_info = mod.read(mod_template)
    ...
    with open(f'{outf}/namecores.txt','w') as namecores:
        ...
        for p_val in p_vals:
            ...
            mod.write(new_ModFile,f'{outf}/modfiles/{namecore}.mod')
...
def validate_args(args):
    ...
    if args.param:
        ...
        args.param = utils.check_scan_param_vals(args.param,float)
    ...
    #Else if z_scan
        ...
        args.param = utils.check_scan_param_vals(z_info,float)
