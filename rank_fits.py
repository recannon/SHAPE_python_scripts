from pyshape.outfmt import logger, error_exit, safe_exit
...
def rank_fits(dirname:Path, top:int = 5, chi_type:str = 'ALLDATA', percent:bool = False, delete:bool = False):
...
def main():
    ...
    rank_fits(args.dirname,args.top,args.chi_type,args.percent,args.delete)
